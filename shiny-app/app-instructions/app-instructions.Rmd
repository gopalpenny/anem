...
1. Define particles
    ...
    + **NOTE:** Flow is non-reactive and non-dispersive. This means that travel times represent the "average" particle, but due to "dispersive" behavior of groundwater, some particle would arrive in less or more time. Furthermore, this analysis would greatly underestimate the effect of macropores on travel times -- meaning transit times could be considerably lower!
