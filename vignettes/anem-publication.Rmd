...
![Figure 2. Groundwater modeling interface for anem. Separate panels allow the user to define aquifer properties, well, properties, and particle tracking. Additional tabs (not shown) allow the user to toggle between scenario preparation and results.](images/three_rivers_aquifer.png)
