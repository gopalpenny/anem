...
#   mutate(type=factor(sign(Q),levels=c(-1,0,1),labels=c("pumping","defunct","injection"))) %>%
#   mutate(Q=c(-0.03,0.01))
...
#   geom_point(data=well_images,aes(x,y0,fill=Q),alpha=0.5,size=3,shape=21) + 
